...
typedef struct expdesc {
  ...
  lu_byte etype;  /* Mos: expression type (MOS_TYPE_*) */
} expdesc;
...
/* Mos: Type codes for static type checking */
#define MOS_TYPE_UNKNOWN  0
#define MOS_TYPE_INT      1
#define MOS_TYPE_FLOAT    2
#define MOS_TYPE_BOOL     3
#define MOS_TYPE_STRING   4
#define MOS_TYPE_VOID     5
/* MOS_TYPE_ANY removed - Mos is a pure static typed language */
...
typedef union Vardesc {
  struct {
    ...
    lu_byte kind;
    lu_byte vtype;  /* Mos: variable type (MOS_TYPE_*) */
    lu_byte ridx;  /* register holding the variable */
...
typedef struct FuncState {
  ...
  lu_byte isapi;  /* function is marked as @API */
  lu_byte rettype;  /* Mos: function return type (MOS_TYPE_*) */
} FuncState;
