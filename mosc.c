/*
** $Id: mosc.c $
** Mos compiler (saves bytecodes to files; also lists bytecodes)
...
#define mosU_print	PrintFunction

#define PROGNAME	"mosc"		/* default program name */
...
static int pmain(lua_State* L)
{
 ...
 f=combine(L,argc);
 if (listing) mosU_print(f,listing>1);
 if (dumping)
 {
