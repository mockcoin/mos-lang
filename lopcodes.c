...
/*       MM OT IT T  A  mode		   opcode  */
 ...
 ,opmode(0, 0, 0, 0, 1, iABC)		/* OP_ADD_I */
 ,opmode(0, 0, 0, 0, 1, iABC)		/* OP_ADD_F */
 ,opmode(0, 0, 0, 0, 1, iABC)		/* OP_SUB_I */
 ,opmode(0, 0, 0, 0, 1, iABC)		/* OP_SUB_F */
 ,opmode(0, 0, 0, 0, 1, iABC)		/* OP_MUL_I */
 ,opmode(0, 0, 0, 0, 1, iABC)		/* OP_MUL_F */
 ,opmode(0, 0, 0, 0, 1, iABC)		/* OP_DIV_I */
 ,opmode(0, 0, 0, 0, 1, iABC)		/* OP_DIV_F */
