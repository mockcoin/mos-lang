...
#define LUA_VERSUFFIX          "_" MOS_VERSION_MAJOR "_" MOS_VERSION_MINOR
...
#define LUA_STRINGMETHODSLIBNAME	"stringmethods"
#define LUA_STRINGMETHODSLIBK	(LUA_UTF8LIBK << 1)
LUAMOD_API int (luaopen_stringmethods) (lua_State *L);

#define LUA_ARRAYMETHODSLIBNAME	"arraymethods"
#define LUA_ARRAYMETHODSLIBK	(LUA_STRINGMETHODSLIBK << 1)
LUAMOD_API int (luaopen_arraymethods) (lua_State *L);

#define LUA_MAPMETHODSLIBNAME	"mapmethods"
#define LUA_MAPMETHODSLIBK	(LUA_ARRAYMETHODSLIBK << 1)
